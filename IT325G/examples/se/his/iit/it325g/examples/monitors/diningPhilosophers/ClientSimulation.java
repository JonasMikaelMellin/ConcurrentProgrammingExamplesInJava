...
public class ClientSimulation implements Runnable {
	...
	public void run() {
		...
		while (true) {
			System.out.println("Process "+AndrewsProcess.currentAndrewsProcessId()+" waiting at ");
			GlobalProgramState.eatingController.request(AndrewsProcess.currentAndrewsProcessId());
			...
			GlobalProgramState.eatingController.release(AndrewsProcess.currentAndrewsProcessId());
