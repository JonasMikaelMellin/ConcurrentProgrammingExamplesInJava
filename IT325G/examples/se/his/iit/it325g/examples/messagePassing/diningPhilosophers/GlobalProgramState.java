...
public class GlobalProgramState {
	public volatile static Vector<AsynchronousChan<Integer>> fork=new Vector<AsynchronousChan<Integer>>();
	...
	public static void main(String argv[]) {
		...
		for (int i=0; i<GlobalProgramState.n; ++i) {
			fork.addElement(new AsynchronousChan<Integer>());
		}
		...
		rs[0]=new RunnableSpecification(Philosopher.class,n);
		rs[1]=new RunnableSpecification(Initiator.class,1);
		try {
